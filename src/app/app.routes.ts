...
import { EditSchoolNeedComponent } from './school-admin/edit-school-need/edit-school-need.component';
...
export const routes: Routes = [
  ...
  { path: 'school-admin/about-us', component: StakeholdersComponent },
  {
    ...
    children: [
      ...
      { path: 'edit-school-need/:id', component: EditSchoolNeedComponent },
    ]
  },
